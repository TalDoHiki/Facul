CREATE DATABASE  IF NOT EXISTS `fund_mod_databank` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fund_mod_databank`;
-- MySQL dump 10.13  Distrib 8.0.32, for Win64 (x86_64)
--
-- Host: localhost    Database: fund_mod_databank
-- ------------------------------------------------------
...
CREATE TABLE `jogos` (
  ...
  `gênero` varchar(10) DEFAULT NULL,
  `data_de_lançamento` date DEFAULT NULL,
  `qnt_de_jogadores` varchar(3) DEFAULT NULL,
...
-- Dump completed on 2023-02-19 16:36:14
